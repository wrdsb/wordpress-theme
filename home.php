...
<div class="container">
    ...
    if (($has_left === TRUE) and ($has_right === TRUE)):
      ...
      if (is_front_page() && wrdsb_i_am_a_school()) { // corp buttons ?>
        ...
        <p><a href="https://bit.ly/3bubExw" onclick="ga('send','event','schoolBanners','click_banner','dailyscreeningchecklist'" target="_blank" rel="noopener"><img src="https://www.wrdsb.ca/wp-content/uploads/Daily-Screening-Checklist.png" alt="Daily Screening Checklist" /></a></p>
