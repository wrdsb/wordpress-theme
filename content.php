...
<?php
	...
	if (!isset($display_cats) && isset($display_tags)) {
		echo '<p class="categories gray-dark small">Tags: ' . the_tags('',' &bull; ','') . '</p>';
	} elseif (isset($display_cats) && !isset($display_tags)) {
		echo '<p class="categories gray-dark small">Categories: ' . the_category(' &bull; ') . '</p>';
	} elseif (isset($display_cats) && isset($display_tags)) {
		echo '<p class="categories gray-dark small">Categories: ' . the_category(' &bull; ') . ' Tags: ' . the_tags('',' &bull; ','') . '</p>';
	}
?>
