...
function new_excerpt_more($more) {
  global $post;
  return ' [...]<p class="readmore"><a href="'. get_permalink($post->ID) . '"><strong>Read the full post entitled</strong> <cite>'. get_the_title($post->ID) .'</cite> &#187;</a></p>';
}
add_filter('excerpt_more', 'new_excerpt_more');

// Adds a custom link for custom excerpts
function new_custom_excerpt_more($custom_more) {
  global $post;
